...
import com.mysoft.b2b.commons.classes.ObjectUtils;
import com.mysoft.b2b.commons.collection.CollectionUtils;
...
public abstract class StringUtils {
	private static final String[] UPPER_DIGIT = { "一", "二", "三", "四", "五", "六",
			"七", "八", "九" };
	 ...
	 * @param obj
	 * @return 例如： for:
	 *         ['40288007318493de0131849474690001','40288007318493de0131849474690001'
	 *         ] to
	 *         :'40288007318493de0131849474690001','40288007318493de0131849474690001
	 *         '
	 */
	 ...
	 * @param ids
	 *            获取的所有的ID
	 * @return 例如：传入idName = "id" 返回样式如下： ( id=
	 *         '40288007318493de0131849474690001' or id=
	 *         '40288007318493de01318496e3270002' )
	 */
	...
	public static String[] delimitedListToStringArray(String str,
		...
		if ("".equals(delimiter)) {
			...
			while ((delPos = str.indexOf(delimiter, pos)) != -1) {
				result
						.add(deleteAny(str.substring(pos, delPos),
								charsToDelete));

 ...
 * DateUtils.java
 */
package com.mysoft.b2b.commons.date;
...
public class DateUtils {
	...
	static {
	    ...
	    formats.put(DATE_FORMAT, format);
	    format = new SimpleDateFormat(TIMEF_FORMAT);
        format.setTimeZone(TimeZone.getDefault());
        formats.put(TIMEF_FORMAT, format);
	    format = new SimpleDateFormat(TIME_FORMAT);
        format.setTimeZone(TimeZone.getDefault());
        formats.put(TIME_FORMAT, format);
	    format = new SimpleDateFormat(TIMEF_FORMAT_2);
        format.setTimeZone(TimeZone.getDefault());
        formats.put(TIMEF_FORMAT_2, format);
	    format = new SimpleDateFormat(MSEL_FORMAT);
        format.setTimeZone(TimeZone.getDefault());
        formats.put(MSEL_FORMAT, format);
	    format = new SimpleDateFormat(ZHCN_DATE_FORMAT);
        format.setTimeZone(TimeZone.getDefault());
        formats.put(ZHCN_DATE_FORMAT, format);
	    format = new SimpleDateFormat(ZHCN_DATE_YEAR_MONTH);
        format.setTimeZone(TimeZone.getDefault());
        formats.put(ZHCN_DATE_YEAR_MONTH, format);
	    format = new SimpleDateFormat(ZHCN_DATE_FORMAT2);
        format.setTimeZone(TimeZone.getDefault());
        formats.put(ZHCN_DATE_FORMAT2, format);
	    format = new SimpleDateFormat(ZHCN_TIME_FORMAT);
        format.setTimeZone(TimeZone.getDefault());
        formats.put(ZHCN_TIME_FORMAT, format);
	    format = new SimpleDateFormat(ZHCN_MSEL_FORMAT);
        format.setTimeZone(TimeZone.getDefault());
        formats.put(ZHCN_MSEL_FORMAT, format);
	    format = new SimpleDateFormat(DATE_STR_FORMAT);
        format.setTimeZone(TimeZone.getDefault());
        formats.put(DATE_STR_FORMAT, format);
	    format = new SimpleDateFormat(TIME_STR_FORMAT);
        format.setTimeZone(TimeZone.getDefault());
        formats.put(TIME_STR_FORMAT, format);
	    format = new SimpleDateFormat(MSEL_STR_FORMAT);
        format.setTimeZone(TimeZone.getDefault());
        formats.put(MSEL_STR_FORMAT, format);
	}
...
//		Calendar now = Calendar.getInstance(TimeZone.getDefault());
    ...
    public static boolean isDate(String strIn, String formatStr) {
        if ((null == strIn || "".equals(strIn.trim()))
                || (null == formatStr || "".equals(formatStr.trim()))
    ...
    public static void main(String[] args) {
        String dd="2013-05-10";
        System.out.println(DateUtils.getDate(dd, DateUtils.DATE_FORMAT));
        System.out.println(judgmentDate(DateUtils.getDate(dd, DateUtils.DATE_FORMAT)));
        
        Date d = getFirstMonthDay(new Date());
        String tmp = getCurYearMonth();
